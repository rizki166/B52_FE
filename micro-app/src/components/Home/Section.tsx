    ...
    <section className="mt-2">
      <div className="p-2 mb-3">
        {data.id === 1 && (
         ...
         <img src={data.image} alt="kpu" className="w-[40rem] h-[24rem] " />
         <div className="absolute bottom-0 left-0">
           ...
           <button className="text-white text-3xl font-semibold "  onClick={() => navigate('/DetailPage')}>
             {data.title}
           </button>
        ...
        {data.id > 1 && (
          <div className=" flex flex-wrap bg-white w-[20rem] h-11/12 m-1">
            ...
            <div className="bg-red-600 w-auto  rounded-lg m-3 p-2 mt-4">
              <button className="text-white font-bold text-xl  "  onClick={() => navigate('/DetailPage')}>{data.date}</button>
            </div>
            <div className="">
              <h1 className="text-3xl  font-bold ">
                <Link to="/DetailPage"> {data.title} </Link>
              </h1>
